# Contributing to Stress Element Analyser Tool
...
### Reporting Bugs
- Use the  [GitHub Issues tab](https://github.com/kayspace/stress-element-analyser/issues)
...
2. **Clone** your fork locally:
   ```bash
   git clone git@github.com:kayspace/stress-element-analyser.git
   ```
3. **Check the issue**
...
Thank you for contributing to stress element analyser! 